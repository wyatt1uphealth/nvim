...
local config = {
  ...
  settings = {
    java = {
      ...
      home = '/Users/wyatt/.sdkman/candidates/java/17.0.12-amzn/bin/java',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = 'JavaSE-11',
            path = '/Users/wyatt/.sdkman/candidates/java/11.0.21-amzn/.',
          },
          {
            name = 'JavaSE-17',
            path = '/Users/wyatt/.sdkman/candidates/java/17.0.12-amzn/.',
          },
        },
      },
      maven = {
